...
pub fn verify_ed25519(
    ...
    require!(signed_pubkey == expected_pubkey.as_ref(), HatTrickError::InvalidOracleSignature);
    require!(signed_msg == expected_message, HatTrickError::InvalidOracleSignature);
    Ok(())
}
