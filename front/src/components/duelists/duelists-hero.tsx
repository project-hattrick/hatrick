...
export function DuelistsHero({ title, intro }: DuelistsHeroProps) {
  return (
    <section className="relative overflow-hidden py-10 text-center sm:py-14">
      <h1
        className={cn(
          sairaCondensed.className,
          'relative inline-block -skew-x-12 text-[clamp(56px,9vw,120px)] leading-none tracking-tight uppercase',
        )}
      >
