  ...
  return (
    <GlassPanel tone="surface" className="flex flex-col overflow-hidden">
      <div className="pitch-stripes relative h-48 md:h-52">
        ...
        <span className="absolute top-3 left-3.5 inline-flex items-center gap-1.5 rounded-full border border-live/40 bg-overlay/55 px-2.5 py-1 text-micro font-bold text-live">
        ...
        <div className="absolute right-3.5 bottom-3 left-3.5 flex items-center gap-2.5">
          ...
          <span className="ml-auto inline-flex items-center gap-1.5 rounded-lg border border-white/15 bg-overlay/60 px-2.5 py-1 text-xs font-bold text-white backdrop-blur-sm">
