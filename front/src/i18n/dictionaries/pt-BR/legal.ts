export const legal = {
  ...
  privacy: {
    ...
    intro:
      'Este wireframe descreve como o Hatrick (demo devnet) trataria seus dados. Não é aconselhamento jurídico - o texto final depende de revisão.',
    sections: [
  ...
  terms: {
    ...
    updated: '30 de junho de 2026',
    intro:
      'Estes termos são texto provisório do MVP para a demo devnet do Hatrick. Os termos finais exigem revisão jurídica antes do lançamento.',
    sections: [
      { heading: 'Elegibilidade', body: 'Você precisa ter 18 anos ou mais para usar áreas de apostas. Ao usar o Hatrick, você confirma que atende aos requisitos de idade e jurisdição.' },
  ...
  responsibleGaming: {
    ...
    description: 'Nosso compromisso com uma experiência segura, justa e responsável no Hatrick.',
    updated: '30 de junho de 2026',
    intro:
      'O Hatrick é uma demo devnet com dinheiro fictício, mas ainda modela controles de jogo responsável e proteções claras ao usuário.',
    sections: [
      { heading: 'Apenas 18+', body: 'O Hatrick é destinado exclusivamente a usuários com 18 anos ou mais. Ao acessar qualquer área de previsão ou aposta, você confirma que atende à idade mínima exigida na sua jurisdição. Podemos solicitar comprovação de idade a qualquer momento.' },
      { heading: 'Dinheiro fictício / devnet', body: 'Esta plataforma roda na Solana Devnet. Todos os tokens, créditos e ganhos são dinheiro fictício sem valor monetário real. Nada no Hatrick constitui aposta com dinheiro real. Nenhuma compra é necessária para aproveitar qualquer recurso.' },
  ...
  cookies: {
    ...
    description: 'Como o Hatrick usa cookies e armazenamento do navegador, e como você pode gerenciá-los.',
    updated: '30 de junho de 2026',
    intro:
      'Esta página explica o armazenamento mínimo que o Hatrick usa para manter a demo devnet funcional.',
    sections: [
      { heading: 'O que são cookies?', body: 'Cookies são pequenos arquivos de texto colocados no seu dispositivo quando você visita um site. O Hatrick usa um único cookie do navegador mais armazenamento local apenas para manter você conectado e lembrar preferências - nunca para rastrear você pela web ou exibir anúncios.' },
      ...
      { heading: 'Sem rastreamento ou publicidade', body: 'Atualmente, o Hatrick não usa analytics de terceiros, publicidade ou cookies de rastreamento entre sites. Se introduzirmos analytics opcionais no futuro, pediremos seu consentimento primeiro e atualizaremos esta política antes de definir qualquer cookie desse tipo.' },
      ...
      { heading: 'Atualizações desta política', body: 'Podemos atualizar esta Política de Cookies periodicamente. A data de "Última atualização" acima reflete a revisão mais recente. O uso contínuo do Hatrick após uma atualização significa aceitação da política revisada.' },
    ],
  },
  geoRestricted: {
    ...
    updated: '30 de junho de 2026',
    intro:
      'O Hatrick mantém recursos de fantasy e visualização de partidas disponíveis quando possível, enquanto bloqueia áreas de apostas em regiões restritas.',
    sections: [
      ...
      { heading: 'O que você ainda pode fazer', body: 'O restante do Hatrick permanece aberto: abrir pacotes, montar seu XI fantasy, acompanhar a visualização 2D da partida ao vivo e explorar a loja. Apenas as áreas de apostas são bloqueadas.' },
      { heading: 'Dinheiro fictício / devnet', body: 'O Hatrick roda na Solana Devnet com dinheiro fictício sem valor real. Esta restrição geográfica modela os controles de compliance que uma casa de apostas em produção aplicaria.' },
    ],
  },
} as const;
