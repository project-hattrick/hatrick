export const home = {
  srTitle: 'Hat-trick - futebol Live e Fantasy para a Copa do Mundo',
  site: {
    title: 'Hat-trick - futebol Live e Fantasy em uma só plataforma',
    description:
  ...
  footer: {
    ...
    getApp: 'Baixe o app',
    copyright: '© 2026 Hat-trick. Todos os direitos reservados.',
