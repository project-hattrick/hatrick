export const legal = {
  ...
  privacy: {
    ...
    intro:
      'This wireframe describes how Hat-trick (devnet demo) would handle your data. Not legal advice - final copy pending review.',
    sections: [
  ...
  terms: {
    ...
    updated: 'June 30, 2026',
    intro:
      'These terms are MVP placeholder copy for the Hat-trick devnet demo. Final terms require legal review before launch.',
    sections: [
  ...
  responsibleGaming: {
    ...
    updated: 'June 30, 2026',
    intro:
      'Hat-trick is a play-money devnet demo, but it still models responsible-gaming controls and clear user protections.',
    sections: [
      { heading: '18+ only', body: 'Hat-trick is intended exclusively for users aged 18 and above. By accessing any prediction or betting surface you confirm that you meet the minimum age requirement in your jurisdiction. We reserve the right to request proof of age at any time.' },
      { heading: 'Play-money / devnet', body: 'This platform runs on Solana Devnet. All tokens, credits and winnings are fictitious play-money with zero real-world monetary value. Nothing on Hat-trick constitutes real-money gambling. No purchase is necessary to enjoy any feature.' },
  ...
  cookies: {
    ...
    updated: 'June 30, 2026',
    intro:
      'This page explains the minimal storage Hat-trick uses to keep the devnet demo functional.',
    sections: [
      { heading: 'What are cookies?', body: 'Cookies are small text files placed on your device when you visit a website. Hat-trick uses a single browser cookie plus local storage, only to keep you signed in and remember your preferences - never to track you across the web or serve advertising.' },
      ...
      { heading: 'No tracking or advertising', body: 'Hat-trick currently runs no third-party analytics, advertising, or cross-site tracking cookies. If we introduce optional analytics in the future, we will ask for your consent first and update this policy before any such cookie is set.' },
      ...
      { heading: 'Updates to this policy', body: 'We may update this Cookie Policy from time to time. The "Last updated" date above reflects the most recent revision. Continued use of Hat-trick after a policy update constitutes acceptance of the revised policy.' },
    ],
  },
  geoRestricted: {
    ...
    updated: 'June 30, 2026',
    intro:
      'Hat-trick keeps fantasy and match-viewing features available where possible, while blocking betting surfaces in restricted regions.',
    sections: [
      ...
      { heading: 'What you can still do', body: 'The rest of Hat-trick remains open: open packs, build your fantasy XI, follow the 2D live match view, and explore the store. Only the betting surfaces are blocked.' },
      { heading: 'Play-money / devnet', body: 'Hat-trick runs on Solana Devnet with fictitious play-money that has no real-world value. This geo-restriction models the compliance controls a production sportsbook would apply.' },
    ],
  },
} as const;
