...
export class FixtureScoreDto {
  ...
  @ApiProperty({ description: 'Home goals from Score.Participant1.Total.Goals.' }) home!: number;
  @ApiProperty({ description: 'Away goals from Score.Participant2.Total.Goals.' }) away!: number;
